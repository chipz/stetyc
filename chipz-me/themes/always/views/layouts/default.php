...
<?php echo $template['body'];?>
	...
	<div id="text-3" class="widget widget_text">
		...
		<div class="textwidget">
			<ul>
			<li><a href="<?php echo base_url() ;?>downloads/irama-hati2.mp3">Irama Hati<a></li>
			<li><a href="<?php echo base_url() ;?>downloads/baby-blue2.mp3">My Baby Blue<a></li>
			<li><a href="<?php echo base_url() ;?>downloads/belajar-bijaksana2.mp3">Belajar Bijaksana<a></li>
			<ul>
		</div>
	</div>
	<div id="text-4" class="widget widget_text">
		<h3>Today's Quote</h3>
		<div class="textwidget">Music can change the world because it can change people. - Bono</div>
	</div>		           
