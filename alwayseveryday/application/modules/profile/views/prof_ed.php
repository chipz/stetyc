<html>
	...
	<div id="form_input">
	<table>
	<?php echo form_open('profile/submit'); ?>
	...
	<tr>
        <td> <?php echo form_label('pic_url : ');?> </td>
        <td> <?php echo form_input('pic_url',$fpic_url,'id="pic_url"'); ?></td>
        </tr>
	</table><br/>
        <?php echo form_textarea('content',$fcontent,'id="content"'); ?><br/>
